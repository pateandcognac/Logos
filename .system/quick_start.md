...
def logos.waypoints.normalize_pose(pose=None, x=None, y=None, z=None, theta_deg=None, ...) -> Dict: ...
def logos.waypoints.upsert(waypoint_id: str, pose=None, current_pose: bool=False, **fields) -> Dict: ...
def logos.waypoints.upsert_here(waypoint_id: str, **fields) -> Dict: ...
def logos.waypoints.update(id_or_name: str, pose=None, current_pose: bool=False, **changes) -> Dict: ...
def logos.waypoints.remove(id_or_name: str) -> Dict: ...
...
# Pose inputs can be ROS Pose/PoseStamped/Odometry/Transform/Pose2D objects or
# equivalent nested dicts, canonical position+rpy_deg, flat x/y/theta_deg, or
# [x,y,theta_deg]/[x,y,z,theta_deg]. Declared non-map frames are rejected.
# New waypoints default navigable=False. Writes are validated and atomic.
